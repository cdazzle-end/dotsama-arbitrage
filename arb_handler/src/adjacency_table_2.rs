...
impl AdjacencyTable2{
        ...
        for lp in &lp_registry.liq_pools{   
            ...
            if let Some(x) = &lp.exchange{
                ...
                adjacency_table.add_dex_pair_to_table(asset_1, liquidity_1, asset_0, liquidity_0);
            }
        }
        adjacency_table
    }
    ...
    fn add_dex_pair_to_table(
        ...
        for adjacency_list in table_bucket{
            ...
            if base_asset_key == adjacency_list_key{
                adjacency_list.add_dex_pair(adjacent_asset, base_liquidity, adjacent_liquidity);
                inserted = true;
                break;
            }
        }
...
impl AdjacencyList{
    ...
    pub fn add_dex_pair(&mut self, adjacent_assets: AssetPointer, base_liquidity: u128, adjacent_liquidity: u128){
        let pair = AdjacencyGroup::new_dex_pair(Rc::clone(&adjacent_assets), base_liquidity, adjacent_liquidity);
        self.list.push(pair);
    }
...
impl AdjacencyGroup{
    pub fn new_dex_pair(adjacent_asset: AssetPointer, base_liquidity: u128, adjacent_liquidity: u128) -> AdjacencyGroup{
        AdjacencyGroup{
