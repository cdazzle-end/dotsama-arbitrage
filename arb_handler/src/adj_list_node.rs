...
type AdjListNodeRef = Rc<RefCell<AdjListNode>>;
...
impl AdjListNode{
    ...
    pub fn new(token_symbol: String, weight: (u128,u128)) -> AdjListNodeRef{
    ...
    pub fn new_head(token_symbol: String) -> AdjListNodeRef{
        Rc::new(RefCell::new(AdjListNode{
            token_symbol,
            weight: (0,0),
            next: None,
